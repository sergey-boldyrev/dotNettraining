                        ...
                        switch (choice_int)
                        {
                            case 1:
                                if (num_books > 0)
                                {
                                    ...
                                    while (dr2.Read())
                                    {
                                        Console.WriteLine("ID: {0}, NAME: {1}, AUTHOR1: {2}, AUTHOR2: {3}, AUTHOR3: {4}, PUBLISHED: {5}", dr2[0], dr2[5], dr2[1], dr2[2], dr2[3], dr2[4]);
                                    }
                                    dr2.Close();
                            ...
                            case 2:
                                ...
                                //DisplayBook(new_one);
                                string strSQL3 = string.Format("SELECT * FROM books WHERE NAME = '{0}'", new_one.name);
                                SqlCommand myCommand3 = new SqlCommand(strSQL3, cn);
                                SqlDataReader dr3 = myCommand3.ExecuteReader();
                                bool book_present = dr3.HasRows;
                                dr3.Close();
                                ...
                                if (!book_present)//(presentBooks.Contains(localPath + new_one.name) != true)
                                {
                                    ...
                                    string strSQL4 = string.Format("INSERT INTO books ("+ fields +") VALUES (" + values + ")",
                                        new_one.name,
                                        new_one.published);
